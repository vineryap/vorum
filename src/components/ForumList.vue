            ...
            >
                ...
                <ul class="flex flex-col divide-y w-full">
                    <li
                        ...
                        sm="px-5"
                    >
                        <div v-if="forum" class="flex flex-1 items-center p-4 content-center">
                            ...
                            >
                                ...
                                <div class="text-gray-600 dark:text-gray-200 text-xs">
                                    by
                                    <a href="profile.html">{{ forum.lastThreadUser.username }}</a>,
                            ...
                            >
                                <router-link
                                    v-if="forum.lastThreadUser"
                                    :to="{ name: 'UserProfile', params: { userId: forum.lastThreadUser.id } }"
...
const { forums, categoryName, categoryId, categoryDescription } = props
